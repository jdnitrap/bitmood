...
class Constraint {
 public:
  ...
  // How well the text so far meets goals the constraint can't force
  // (used to score best-of-N candidates). 0 = neutral.
  virtual double satisfaction() const { return 0.0; }
};
